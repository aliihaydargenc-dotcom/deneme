...
const EN_TO_TR = {
  ...
  'Visual Catalog Mode': 'Görsel Katalog Modu',
  '⚡ Command Mode': '⚡ Komut Modu',
  'Switch to minimal search-focused homepage': 'Minimal, arama odaklı ana sayfaya geç',
  'Explore Uvero\'s Private Digital Workspace': 'Uvero’nun Gizli Dijital Çalışma Alanını Keşfet',
  'P2P file transfer, convert files, generate QR codes, share encrypted text, and run code — 100% in your browser.': 'P2P dosya aktarımı yap, dosyaları dönüştür, QR kodları oluştur, şifreli metin paylaş ve kod çalıştır — tamamı tarayıcında.',
  'Service Pillars': 'Temel Hizmetler',
  'File Transfer': 'Dosya Aktarımı',
  'Instant browser-to-browser WebRTC file transfer. High-speed socket connection with 6-digit PIN & QR pairing.': 'Tarayıcıdan tarayıcıya anında WebRTC dosya aktarımı. 6 haneli PIN ve QR eşleştirme ile yüksek hızlı bağlantı.',
  'Toolbox & PDF Suite': 'Araç Kutusu ve PDF Paketi',
  'File converters for documents and media, plus full PDF suite to merge, split, compress & protect PDFs.': 'Belge ve medya dönüştürücüleriyle birlikte PDF birleştirme, bölme, sıkıştırma ve koruma araçları.',
  'QR Tools & Studio': 'QR Araçları ve Stüdyo',
  'Generate custom QRs with logos, camera scanner, bulk generation, dynamic redirects & scan analytics.': 'Logolu özel QR kodları oluştur, kamerayla tara, toplu üretim yap, dinamik yönlendirme ve tarama analizlerini kullan.',
  'Live Clipboard': 'Canlı Pano',
  'Share text across devices privately with password lock, burn-after-read, auto expiry & CLI access.': 'Metni cihazlar arasında gizli biçimde paylaş; şifre kilidi, okuduktan sonra silme, otomatik süre sonu ve CLI erişimini kullan.',
  'Code Compiler': 'Kod Çalıştırıcı',
  'Monaco editor for running Python, JavaScript, C++, Go, Rust, and HTML online with stdin/stdout.': 'Python, JavaScript, C++, Go, Rust ve HTML kodlarını stdin/stdout desteğiyle çalıştıran Monaco editörü.',
  '100% In-Browser Privacy:': '%100 Tarayıcı İçi Gizlilik:',
  'Files & code process locally on your device via WASM and P2P WebRTC.': 'Dosyalar ve kodlar WASM ve P2P WebRTC ile cihazında yerel olarak işlenir.',

  'Convert a PDF to images...': 'PDF’yi görsellere dönüştür...',
  'Generate a QR code for WiFi...': 'WiFi için QR kod oluştur...',
  'Compress this image...': 'Bu görseli sıkıştır...',
  'Share a code snippet...': 'Kod parçası paylaş...',
  'Resize a photo...': 'Bir fotoğrafı yeniden boyutlandır...',
  'Run Python code...': 'Python kodu çalıştır...',
  'Split a bill with friends...': 'Hesabı arkadaşlarınla bölüş...',
  'Remove image background...': 'Görsel arka planını kaldır...',
  'Convert audio to MP3...': 'Sesi MP3’e dönüştür...',
  'Generate a QR for a link...': 'Bağlantı için QR oluştur...',
  'Convert a PDF to images': 'PDF’yi görsellere dönüştür',
  'Generate a QR code for WiFi': 'WiFi için QR kod oluştur',
  'kg to lbs': 'kg’yi lb’ye dönüştür',
